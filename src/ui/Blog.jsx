...
import { createPostRequest } from "../features/postSlice";
...
"
        ...
        <DisplayMessage
          title="Запись создана, но не будет обновляться на сервере в соответствии с условиями API. Проверьте вкладку сети на статус 200 OK.
